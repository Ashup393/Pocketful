...
import logo from '../Images/labourimage.jpg';
  ...
  const[inhover,outhover]=useState(true)
    return (
      <div className='MainHome'>
       ...
       <button onClick={()=> outhover(!inhover) }   style={{background:"black",color:'gray', cursor:"pointer",padding:"1rem"}}><DehazeIcon/></button>
       ...
       <section >
        ...
        onMouseLeave={() => outhover(false)}className="unorderedlist"  style={{listStyleType:"none", transition: "all 1s ease", width:"fit-content" ,margin: 0,padding: 0,paddingLeft:"1.9%" ,backgroundColor:"black"}}  className='header'>
